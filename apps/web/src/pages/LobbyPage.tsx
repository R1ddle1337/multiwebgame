    ...
    <main className="content-grid lobby-layout">
      <section className="panel">
        ...
        <div className="button-row">
          ...
          <button type="button" onClick={() => createRoom('santorini')}>
            {t('lobby.create.santorini')}
          </button>
          <button type="button" onClick={() => createRoom('onitama')}>
            {t('lobby.create.onitama')}
          </button>
          <button type="button" onClick={() => createRoom('battleship')}>
            {t('lobby.create.battleship')}
          </button>
          <button type="button" onClick={() => createRoom('yahtzee')}>
            {t('lobby.create.yahtzee')}
          </button>
          <button type="button" onClick={() => createRoom('domination')}>
            {t('lobby.create.domination')}
          </button>
