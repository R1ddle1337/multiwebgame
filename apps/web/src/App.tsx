    ...
    <div className="shell">
      <header className="topbar">
        <div>
          ...
          <span className="status-pill">
            {t('enum.game.santorini')} {user.ratings.santorini ?? 1200}
          </span>
          <span className="status-pill">
            {t('enum.game.onitama')} {user.ratings.onitama ?? 1200}
          </span>
          <span className="status-pill">
            {t('enum.game.battleship')} {user.ratings.battleship ?? 1200}
          </span>
          <span className="status-pill">
            {t('enum.game.love_letter')} {user.ratings.love_letter ?? 1200}
          </span>
          <span className="status-pill">
            {t('enum.game.codenames_duet')} {user.ratings.codenames_duet ?? 1200}
          </span>
          <span className="status-pill">
          ...
          <span className="status-pill">
            {t('enum.game.cards')} {user.ratings.cards ?? 1200}
          </span>
          <span className="status-pill">
