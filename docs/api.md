...
- `POST /rooms`
  - Auth required
  - Body: `{ "gameType": "single_2048" | "gomoku" | "santorini" | "onitama" | "battleship" | "love_letter" | "codenames_duet" | "connect4" | "reversi" | "dots" | "go" | "xiangqi" | "backgammon" | "cards" | "quoridor" | "hex" | "liars_dice", "maxPlayers"?: number }`
  - Returns: `{ room }`
